...
character(alpine, 'assets/images/characters/guido.png').
...
link(alpine, 'https://www.formula1.com/en/teams/alpine').
link(astonmartin, 'https://www.formula1.com/en/teams/aston-martin').
link(ferrari, 'https://www.formula1.com/en/teams/ferrari').
link(haas, 'https://www.formula1.com/en/teams/haas').
link(kick, 'https://www.formula1.com/en/teams/kick-sauber').
link(mclaren, 'https://www.formula1.com/en/teams/mclaren').
link(mercedes, 'https://www.formula1.com/en/teams/mercedes').
link(rb, 'https://www.formula1.com/en/teams/racing-bulls').
link(redbull, 'https://www.formula1.com/en/teams/red-bull-racing').
link(williams, 'https://www.formula1.com/en/teams/williams').
